...
export const Home = () => {
  ...
  const infoTextFat =
    "Achte bei dem Verzehr von Fetten auch auf die Quellen. Besonders Nüsse und pflanzliche Öle liefern gesunde ungesättigte Fettsäuren, welche positive Effekte auf den Körper haben. Beispiele hierfür sind die Hirnfunktion oder das Immunsystem.";

  const infoTextCarbs =
    "Besonders der Verzehr komplexer Kohlenhydrate ist vorteilhaft. Sie dienen als Träger von Mineralstoffen, Vitaminen und Ballaststoffen. Versuche, deine Kohlenhydrate aus Vollkornprodukten anstelle von Weißmehlprodukten oder mit Zucker gesüßten Waren zu gewinnen.";
